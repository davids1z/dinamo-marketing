...
class SportsDataMockClient(SportsDataClientBase):
        ...
        return [
            {
                "event_id": "evt_100201",
                "league_id": league_id,
                "home_team": "ShiftOneZero FC",
                "away_team": "Competitor Alpha",
                "home_team_id": "team_soz",
                "away_team_id": "team_competitor_alpha",
                "date": "2026-03-04",
                "time": "20:00",
                "status": "FT",
                "home_score": 3,
    ...
    async def get_team_info(self, team_name: str) -> dict:
        return {
            ...
            "logo_url": "https://media.api-sports.io/football/teams/soz.png",
    ...
    async def get_upcoming_events(self, team_id: str) -> list[dict]:
        return [
            ...
            },
            {
                ...
                "league_id": "2",
                "home_team": "ShiftOneZero FC",
                "away_team": "Competitor Beta",
                "home_team_id": team_id,
                "away_team_id": "team_competitor_beta",
                "date": "2026-03-12",
                "time": "21:00",
                "status": "NS",
                "home_score": None,

...
class YouTubeMockClient(YouTubeClientBase):
    ...
    async def get_channel_stats(self, channel_id: str) -> dict:
        return {
            ...
            "title": "ShiftOneZero Official",
            "description": "Official YouTube channel of ShiftOneZero. Match highlights, interviews, behind the scenes and more.",
            "subscriber_count": 145_000,
            "video_count": 1_284,
            "view_count": 48_750_000,
            "custom_url": "@SOZOfficial",
        ...
        videos = [
            {
                ...
                "title": "MATCH HIGHLIGHTS | SOZ 3-1 Hajduk | Derby Day!",
                "description": "Full highlights from the exciting spring collection launch. Features from our design team.",
                ...
                "like_count": 4_230,
                "comment_count": 892,
                "tags": ["soz", "highlights", "derby", "football", "hnl"],
            },
            {
                "video_id": "dQw4w9WgXcQ_mock02",
                "title": "POST-LAUNCH | CEO's reaction to spring collection success",
                "description": "Our CEO shares thoughts after an incredible launch day performance.",
                ...
                "like_count": 1_870,
                "comment_count": 345,
                "tags": ["soz", "interview", "manager", "derby"],
            },
            {
                ...
                "like_count": 2_100,
                "comment_count": 267,
                "tags": ["soz", "behind the scenes", "matchday", "vlog"],
            },
            {
                "video_id": "dQw4w9WgXcQ_mock04",
                "title": "TOP 10 PRODUCTS | February 2026",
                "description": "The best goals scored by ShiftOneZero in February 2026. Which one is your favourite?",
                ...
                "like_count": 3_450,
                "comment_count": 521,
                "tags": ["soz", "top 10", "goals", "compilation"],
            },
            {
                "video_id": "dQw4w9WgXcQ_mock05",
                "title": "WORKSHOP | Preparing for the Spring Campaign launch",
                "description": "The team prepares ahead of next week's big campaign launch event.",
                ...
                "like_count": 1_320,
                "comment_count": 198,
                "tags": ["soz", "training", "europa league", "football"],
            },
        ]
        return videos[:limit]

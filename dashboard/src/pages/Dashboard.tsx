        ...
        <div className="card">
          ...
          <div className="space-y-2.5">
            {activities.map((item) => {
              ...
              return (
                <div key={item.id} className={`flex items-start gap-3 p-3.5 rounded-xl bg-gray-50 hover:bg-white transition-all border border-gray-200 border-l-[3px] ${iconInfo.border}`}>

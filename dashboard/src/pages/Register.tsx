        ...
        >
          <div className="flex flex-col items-center mb-4 sm:mb-6">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-slate-100/80 flex items-center justify-center mb-3 sm:mb-5 shadow-sm">
              <UserPlus className="w-5 h-5 text-slate-500" aria-hidden="true" />
            </div>
            <h1
              className="text-lg sm:text-[22px] font-semibold text-slate-800 tracking-[-0.01em]"
          ...
          <form onSubmit={handleSubmit} className="space-y-2.5 sm:space-y-3.5" noValidate>
            <div className="relative">
              <label htmlFor="register-fullname" className="sr-only">Ime i prezime</label>
              <User className="absolute left-3.5 top-1/2 -translate-y-1/2 w-[18px] h-[18px] text-slate-400" aria-hidden="true" />
              <input
            ...
            <div className="relative">
              <label htmlFor="register-email" className="sr-only">E-mail adresa</label>
            ...
            <div className="relative">
              <label htmlFor="register-password" className="sr-only">Lozinka (min. 6 znakova)</label>
            ...
            <div className="relative">
              <label htmlFor="register-confirm-password" className="sr-only">Potvrdi lozinku</label>
              <KeyRound className="absolute left-3.5 top-1/2 -translate-y-1/2 w-[18px] h-[18px] text-slate-400" aria-hidden="true" />
              <input

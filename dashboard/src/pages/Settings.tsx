      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div className="bg-dinamo-dark-card rounded-xl border border-gray-800 p-6">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-lg font-semibold text-white">API integracije</h2>
            <span className="text-xs px-2 py-0.5 rounded-full bg-yellow-900/40 text-yellow-400 ml-2">Sve mock način</span>
          </div>
            ...
            {apis.map((api) => (
              <div
                ...
                className={`rounded-lg border p-4 transition-colors ${
                  api.enabled ? 'bg-dinamo-dark-light/50 border-gray-700' : 'bg-dinamo-dark-card/50 border-gray-800 opacity-60'
                }`}
              >
        ...
        <div className="bg-dinamo-dark-card rounded-xl border border-gray-800 p-6">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-lg font-semibold text-white">Vizualni identitet</h2>
          </div>
          ...
          <div className="mt-6 p-4 bg-dinamo-dark-light/50 rounded-lg border border-gray-700">
        ...
        <div className="bg-dinamo-dark-card rounded-xl border border-gray-800 p-6">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-lg font-semibold text-white">Postavke obavijesti</h2>
          </div>
          ...
          <div className="space-y-3">
            {notifications.map((notif) => (
              <div
                key={notif.id}
                className="flex items-center justify-between p-4 bg-dinamo-dark-light/50 rounded-lg"
              >
                <div>
        ...
        <div className="bg-dinamo-dark-card rounded-xl border border-gray-800 p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-lg font-semibold text-white">Informacije o sustavu</h2>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm">
            ...
            <div>
              ...
              <p className="text-yellow-400 font-mono">Razvoj</p>
            </div>
            <div>
              <p className="text-dinamo-muted">Način podataka</p>
              <p className="text-green-400 font-mono">Mock podaci</p>
            </div>
            <div>
